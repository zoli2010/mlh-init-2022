...
router.post('/play-game', (req, res) => {
  ...
  const handleMatch = () => {
    ...
    if (req.session.wordState.join('') == word) {
      handleGameOver('You guessed the word! Youn win!')
    } else {
