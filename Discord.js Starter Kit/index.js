/*
Hello! Welcome to the discord.js starter kit! This starter kit was made for those who wanted to kickstart their journey into building Discord bots using discord.js, as well as those who are looking for a quick, easy, and accessible template to quickstart their development.

If you're unsure about what a starter kit is, IBM defines it as "an application pattern that can be integrated with services to generate a production-ready asset". Simply put, starter kits contain code that can be reused, instead of reinvented.

This discord.js starter kit was created as a project for MLH INIT 2022, Day 1. If you're curious about what MLH INIT 2022 is, or what MLH is in general, visit https://organize.mlh.io/participants/events/6813-init-2022 or https://mlh.io.

This starter kit isn't a full guide. If you're completely new to discord.js, I'd recommend checking out https://discordjs.guide and https://discord.js.org.
...
client.on('message', message => {
    ...
    // Execute the command. If something goes wrong, alert user.
    try {
